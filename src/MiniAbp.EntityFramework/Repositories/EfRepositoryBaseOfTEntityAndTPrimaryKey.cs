...
namespace MiniAbp.EntityFramework.Repositories
{
    ...
    public class EfRepositoryBase<TDbContext, TEntity, TPrimaryKey> : MabpEfRepositoryBase<TEntity, TPrimaryKey>//, IRepositoryWithDbContext
        ...
        where TDbContext : DbContext
    {
        ...
        protected override IDbTransaction DbTransaction => Context.Database.CurrentTransaction.UnderlyingTransaction;
